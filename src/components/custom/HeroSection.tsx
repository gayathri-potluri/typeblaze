...
export default function TypeBlazeLanding() {
  return (
    <motion.div 
      initial="initial"
      animate="animate"
  ...
  <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%">
    ...
    <rect width="100%" opacity={0.45} height="100%" fill="url(#diagonal-stripes)" />
  </svg>
</div>
      ...
      >
        ...
        >
          ...
          >
            Maximize Your Typing Speed <br /> with <span className='text-blue-500'>TypeBlaze</span>
          </motion.h1>
          <motion.p 
            variants={fadeInUp}
          ...
          >
            <Link
              href="/playground"
              className="bg-blue-500 text-white px-8 py-3 rounded-full hover:bg-blue-600 transition-colors inline-flex items-center text-lg font-medium"
            >
              Start Typing Now
        ...
        >
          ...
          >
            {[
              { icon: BarChart, title: "Detailed Analytics", content: "Monitor your improvement with detailed analytics and insightful performance charts." },
              { icon: Target, title: "Personalized Goals", content: "Define and accomplish personalized typing targets based on your proficiency level." },
              { icon: Zap, title: "Daily Challenges", content: "Engage in fresh typing challenges daily to enhance your speed and accuracy" },
              { icon: Coffee, title: "Typing Breaks", content: "Maintain correct typing posture and schedule regular breaks to avoid strain and fatigue." }
            ].map((item, index) => (
              <motion.div 
                key={index}
                variants={fadeInUp}
        ...
        >
          ...
          >
            &quot;TypeBlaze has significantly boosted my typing speed and accuracy. Improving my skills has never been this enjoyable!&quot;
          </motion.p>
          <motion.div 
            variants={fadeInUp}
